...
//	}
	...
	@GetMapping("/search")
	public RoutingTDInfo getJSON(@RequestParam String serviceID,@RequestParam String operationTD,@RequestParam String uri ) {
			isCharged();
	...
	public MessageResponse getLastChargeDate() {		
			return configService.isValidChargeConf()? new MessageResponse("OK","The RoutingTDConfigFile is valid"): new MessageResponse("KO","The RoutingTDConfigFile is NOT valid");
	}
